...
knitr::include_graphics("ConcurrencyTutorialFiles/concurrency.png")
```
...
```{r, echo=FALSE, out.width="500px"}
knitr::include_graphics("ConcurrencyTutorialFiles/samandchris.png")
```
...
```{r, echo=FALSE, out.width="500px"}
# 400px?
knitr::include_graphics("ConcurrencyTutorialFiles/samandchrisleft.png")
```
...
```{r, echo=FALSE, out.width="500px"}
# 400px?
knitr::include_graphics("ConcurrencyTutorialFiles/samandchrisright.png")
```
...
```{r, echo=FALSE, out.width="500px"}
# 400px?
knitr::include_graphics("ConcurrencyTutorialFiles/samandchriscoitaldilution.png")
```
...
```{r, echo=FALSE, out.width="500px"}
knitr::include_graphics("ConcurrencyTutorialFiles/Pop1.png")
```

After that time, they all end their existing partnerships, and start a new 3-month relationship, as follows:

```{r, echo=FALSE, out.width="500px"}
knitr::include_graphics("ConcurrencyTutorialFiles/Pop2.png")
```
...
```{r, echo=FALSE, out.width="500px"}
knitr::include_graphics("ConcurrencyTutorialFiles/Pop3.png")
```
...
```{r, echo=FALSE, out.width="500px"}
knitr::include_graphics("ConcurrencyTutorialFiles/Pop4.png")
```
...
knitr::include_graphics("ConcurrencyTutorialFiles/samcoital.png")
```
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics("ConcurrencyTutorialFiles/chriscoital.png")
```
...
####  R code for calculating transmission probabilities {#transmissioncalc}
...
knitr::include_graphics("ConcurrencyTutorialFiles/sexspecificconcurrency.png")
```
...
The R code for [Exercise 4](#exercise4) is printed below. Clip the clipboard on the top left to copy, and paste it into a fresh .R file in your working directory (type ```getwd()``` to confirm this location). You can then run the code line by line, or run the entire simulation at once by typing
...
* [http://www.statnet.org](statnet)

* [Network Modeling of Infectious Disease summer short course at the University of Washington](http://statnet.org/nme/)
...
Code can be found in the associated [GitHub repository](https://github.com/statnet/ConcurrencyTutorial).
