...
If you would like a refresher before the numerical exercises, see the [rules of probability](prob-tutorial.qmd) and the [introduction to R](r-tutorial.qmd) in the Appendix section.
