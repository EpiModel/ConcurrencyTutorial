...
For those readers who would like a refresher on the relevant rules of probability, visit our [Probability Tutorial](r-tutorial.qmd).
...
On this page, we provide the numerical answers only. For those readers who wish to see derivations of them, see the Derivations tab.  Or for those readers who had some incorrect answers and want to try again, check out the [Probability Tutorial](r-tutorial.qmd).
